...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  40, 40 }, { 240,  40 }, { 240, 240 }, { 40, 240 } }
   ...
   */
  #define TRAMMING_SCREW_THREAD 51
 ...
 */
  ...
  #if AXIS_IS_TMC(E0) || ENABLED(SKR_E3_MINI_BOARD) || ENABLED(DIY_TMCBOARD) || ENABLED(SKR_E3_MINI_V3_0)
   ...
   */
    ...
    // TMC2209: 0...255. TMC2130: -64...63
      ...
      #define X_STALL_SENSITIVITY  X_SH_CALIBRATION
      #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #endif
    #if ENABLED(Y_AXIS_SENSORLESS_HOMING)
      #define Y_STALL_SENSITIVITY  Y_SH_CALIBRATION
